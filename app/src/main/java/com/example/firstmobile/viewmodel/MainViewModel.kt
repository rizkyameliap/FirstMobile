package com.example.firstmobile.viewmodel
...
import com.example.firstmobile.data.network.Retrofitlnstance
...
class MainViewModel : ViewModel() {
    ...
    fun fetchBooks(query: String) {
        viewModelScope.launch {
            try {
                val response = Retrofitlnstance.api.searchBooks(query, 10)
